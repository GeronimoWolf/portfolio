...
Het resultaat is dat veel Europese marktpartijen onterecht de term private cloud gaan gebruiken. Maar als je vervolgens de oplossing beter bekijkt dan zie je dat het eigenlijk volledig voldoet aan de public cloud kenmerk; de infrastructuur wordt namelijk niet exclusief voor één organisatie ingezet. Veel private clouds in de markt zijn in feite **public cloud** met logische isolatie (multi-tenant, VPC/VNet) óf **managed/hosted** infrastructuur zonder self-service (geen cloud).
